...
(custom-set-variables
 ...
 '(custom-safe-themes
   '("3fe1ebb870cc8a28e69763dde7b08c0f6b7e71cc310ffc3394622e5df6e4f0da"
     ...
     "2e98350610ed0594dab8c55fcb4b4d781e020bf022dda8e7e23b038208cb6e5e"
     "9278d5ab312f1e9de3e1470a93c177db9093051955c316e28a6c76c4049c90d9"
     "6c49dc039a835cc165502093ce3ab2a0d6b06f868dfd04727e88b0d8bc252fa0"
 ...
 '(elfeed-feeds
   '("https://export.arxiv.org/rss/cs.SI"
     "https://export.arxiv.org/rss/cs.IR"
     "https://export.arxiv.org/rss/cs.HC"
     "https://export.arxiv.org/rss/cs.CY"
     "https://ijoc.org/index.php/ijoc/gateway/plugin/WebFeedGatewayPlugin/rss2"
     "https://journals.sagepub.com/action/showFeed?ui=0&mi=ehikzz&ai=2b4&jc=hijb&type=etoc&feed=rss"
     "https://share.osf.io/api/v2/feeds/atom/?elasticQuery=%7B%22bool%22%3A%7B%22must%22%3A%7B%22query_string%22%3A%7B%22query%22%3A%22*%22%7D%7D%2C%22filter%22%3A%5B%7B%22term%22%3A%7B%22sources%22%3A%22SocArXiv%22%7D%7D%5D%7D%7D"
     "https://osf.io/preprints/socarxiv/discover?subject=SocArXiv%7CSocial%20and%20Behavioral%20Sciences"
     "https://academic.oup.com/rss/site_6088/OpenAccess.xml"
     "https://academic.oup.com/rss/site_6088/advanceAccess_3963.xml"
     "https://academic.oup.com/rss/site_6088/3963.xml"
     "https://journals.sagepub.com/action/showFeed?ui=0&mi=ehikzz&ai=2b4&jc=nmsa&type=etoc&feed=rss"
     "https://journals.sagepub.com/connected/NMS#rss-feeds"
     "https://www.tandfonline.com/feed/rss/rica20"
     "https://www.tandfonline.com/feed/rss/upcp20"
     "https://www.tandfonline.com/journals/upcp20"))
 ...
 '(inferior-ess-r-font-lock-keywords
   '((ess-S-fl-keyword:prompt . t) (ess-R-fl-keyword:keywords . t)
     ...
     (ess-fl-keyword:matrix-labels . t) (ess-fl-keyword:fun-calls . t)
 ...
 '(notmuch-saved-searches
   '((:name "BambergNew" :query "tag:Bamberg and tag:unread" :key [98])
     (:name "Calls" :query
            "tag:academic-general and tag:unread and (subject:call or subject:CFP)"
            :key [99])
     (:name "PhD positions" :query
            "tag:academic-general and tag:unread and (subject:PhD or subject:job or subject:position* or subject:recruit*)"
            :key [106])
     (:name "academic" :query "tag:academic-general and tag:unread"
            :key [97])
     (:name "subscriptions" :query "tag:subscriptions" :key [115])
