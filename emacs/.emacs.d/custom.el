...
(custom-set-variables
 ...
 '(notmuch-saved-searches
   '((:name "BambergNew" :query "tag:Bamberg and tag:unread" :key
            [98])
     (:name "Calls" :query "tag:academic-general and tag:unread and (subject:call or subject:CFP)" :key
            [99])
     (:name "PhD positions" :query "tag:academic-general and tag:unread and (subject:PhD or subject:job or subject:position* or subject:recruit*)" :key
            [106])
